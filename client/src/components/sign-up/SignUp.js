...
function SignUp() {
    ...
    //destructure the formData
     const {firstname, middlename, lastname, email, birthdate, username, password, password2, successMsg, errorMsg, loading} = formData;
     ...
     const handleSubmit = (e) =>{
        ...
        //if password is not equal to password2
            ...
            const {firstname, middlename, lastname, email, birthdate, username, password,} = formData
            const data = {firstname, middlename, lastname, email, birthdate, username, password}
        ...
        <div className="main-sign-up">
            <form className="sign-up-form" autoComplete='off' onSubmit={handleSubmit}>
                ...
                {loading && <div className='text-center pb-4'>{showLoading()}</div> }
                    ...
                    <button className="main-sign-up-button">Sign Up</button>
