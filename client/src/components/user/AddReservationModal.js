...
function AddReservationModal () {
  ...
  const handleReservationSubmit = (e) =>{
      ...
      // if(isEmpty(reservations)){
        ...
        //   industrialFan,aeratronFan,coolerfan,others,computers,printers,uncTheaterGuild,collegeBand,hsDxmc,hsMajorettes,
        //   collegeMajorettes,elementaryMajorettes,cat}
        dispatch(createReservation({activityType,title,timeDuration ,numberParticipants,nameOfReqParty,venue,soundSystem,bluetoothSpeaker,microphone,
            projector,projectorScreen,lights,videoDocumentation,photoDocumentation,janitorial,security,electricians,itTechnicians,
            soundOperators,generatorOperators,van,phFlag,uncFlag,aircon,fan,generator,plants,displayBoards,monoblocks,pavillionTable,
            industrialFan,aeratronFan,coolerfan,others,computers,printers,uncTheaterGuild,collegeBand,hsDxmc,hsMajorettes,
            collegeMajorettes,elementaryMajorettes,cat}))
                ...
                {/* Body */}
                  <div className="modal-body my-2">
...

                          {
                            ...
                            (
                              <>
                                <p className='h6 text-danger'>*Select only what is needed in your reservation* </p>
                                 <label className='text-danger mb-5'>I. ACTIVITY TYPE</label>
                                <select name="activityType" onChange={(e) => setActivityType(e.target.value)}
                                 ...
                                 <input type="text" className='form-control' placeholder='*e.g. 1:00PM - 3:00PM' onChange={(e) => setTimeDuration(e.target.value)} />

                                 <label className='text-dark'>Number of Participants</label>
                                 <input type="text" className='form-control' name='numberParticipants' value={numberParticipants} onChange={(e) => setNumberParticipants(e.target.value)} />
                                
                                 <label className='text-dark'>Name Of Requesting Party</label>
                                 <input type="text" className='form-control' name='nameOfReqParty' value={nameOfReqParty} onChange={(e) => setNameOfReqParty(e.target.value)} />

                                 <label className='text-center text-danger mt-5'> II. VENUE</label>
                                  <select name="venue" onChange={(e) => setVenue(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                ...
                                <label className='text-center text-danger mt-5'> III. IMC RESOURCES</label> <br />
                                ...
                                <select name="soundSystem" onChange={(e) => setSoundSystem(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                ...
                                <select name="bluetoothSpeaker" onChange={(e) => setBluetoothSpeaker(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
                                ...
                                <input type="number" className='form-control' name='microphone' value={microphone} onChange={(e) => setmicrophone(e.target.value)} />
                                ...
                                <select name="projector" onChange={(e) => setProjector(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
                                ...
                                <input type="number" className='form-control' name='projectorScreen' value={projectorScreen} onChange={(e) => setProjectorScreen(e.target.value)} />

                                <label className='text-dark'>Lights</label>
                                <input type="number" className='form-control' name='lights' value={lights} onChange={(e) => setLights(e.target.value)} />
                                ...
                                <label className='text-dark'>Video Documentation</label>                      
                                  <select name="videoDocumentation" onChange={(e) => setVideoDocumentation(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
                                ...
                                <label className='text-dark'>Photo Documentation</label>                      
                                  <select name="photoDocumentation" onChange={(e) => setPhotoDocumentation(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
                                ...
                                <label className='text-danger mt-5'>IV. PERSONNEL SERVICES</label> <br />
                                     

                                <label className='text-dark'>Janitorial</label>                      
                                  <select name="janitorial" onChange={(e) => setJanitorial(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
                                  ...
                                  <select name="security" onChange={(e) => setSecurity(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
                                  ...
                                  <select name="electricians" onChange={(e) => setElectricians(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
                                  ...
                                  <select name="itTechnicians" onChange={(e) => setItTechnicians(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
                                  ...
                                  <select name="soundOperators" onChange={(e) => setSoundOperators(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
                                  ...
                                  <select name="generatorOperators" onChange={(e) => setGeneratorOperators(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
                                  ...
                                  <select name="van" onChange={(e) => setVan(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
                                ...
                                <label className='text-danger mt-5'>V. RESOURCES NEEDED</label> <br />

                                  <label className='text-dark'>Philippine Flag</label>                                              
                                  <select name="phFlag" onChange={(e) => setPhFlag(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
                                ...
                                <select name="uncFlag" onChange={(e) => setUncFlag(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
                                ...
                                <select name="aircon" onChange={(e) => setAircon(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
                                ...
                                <select name="fan" onChange={(e) => setFan(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
                                ...
                                <select name="generator" onChange={(e) => setGenerator(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
                                ...
                                <select name="plants" onChange={(e) => setPlants(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
                                ...
                                <input type="number" className='form-control' name='displayBoards' value={displayBoards} onChange={(e) =>setDisplayBoards(e.target.value)} />

                                <label className='text-dark'>Monoblocks</label>
                                <input type="number" className='form-control' name='monoblocks' value={monoblocks} onChange={(e) => setMonoblocks(e.target.value)} />

                                <label className='text-dark'>Pavillion Table</label>
                                <input type="number" className='form-control' name='pavillionTable' value={pavillionTable} onChange={(e) => setPavillionTable(e.target.value)} />

                                <label className='text-dark'>Industrial Fan</label>
                                <input type="number" className='form-control' name='industrialFan' value={industrialFan} onChange={(e) => setIndustrialFan(e.target.value)} />                                
                                
                                <label className='text-dark'>Aeratron Fan</label>
                                <input type="number" className='form-control' name='aeratronFan' value={aeratronFan} onChange={(e) => setAeratronFan(e.target.value)} />

                                <label className='text-dark'>Coolerfan</label>
                                <input type="number" className='form-control' name='coolerfan' value={coolerfan} onChange={(e) => setCoolerfan(e.target.value)} />

                                <label className='text-dark'>Others</label>
                                <input type="text" className='form-control' name='others' value={others} onChange={(e) => setOthers(e.target.value)} />

                                <label className='text-danger mt-5'>VI. ICT RESOURCES</label> <br />

                                <label className='text-dark'>Computers</label>
                                <input type="number" className='form-control' name='computers' value={computers} onChange={(e) => setComputers(e.target.value)} />

                                <label className='text-dark'>Printers</label>
                                <input type="number" className='form-control' name='printers' value={printers} onChange={(e) => setPrinters(e.target.value)} />

                                <label className='text-danger mt-5'>VII. SPECIAL SERVICES</label> <br />
                                ...
                                <select name="uncTheaterGuild" onChange={(e) => setUncTheaterGuild(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
                                ...
                                <select name="collegeBand" onChange={(e) => setCollegeBand(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
                                ...
                                <select name="hsDxmc" onChange={(e) => setHsDxmc(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
                                ...
                                <select name="hsMajorettes" onChange={(e) => setHsMajorettes(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
                                ...
                                <select name="collegeMajorettes" onChange={(e) => setCollegeMajorettes(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
                                ...
                                <select name="elementaryMajorettes" onChange={(e) => setElementaryMajorettes(e.target.value)}
                                    className='custom-select mr-sm-2'>
                                      <option selected>Select Options....</option>
                                      <option>NO</option>
                                      <option>YES</option>
