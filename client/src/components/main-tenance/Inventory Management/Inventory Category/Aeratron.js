...
import { getAllMaintenanceAeratronFan } from "../../../../redux/actions/inventoryAction";
...
function Aeratron() {
  ...
  useEffect(() => {
    dispatch(getAllMaintenanceAeratronFan());
  }, [dispatch]);
