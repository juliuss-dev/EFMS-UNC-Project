...
import { getAllMaintenanceIndustrialFan } from "../../../../redux/actions/inventoryAction";

function IndustrialFan() {
  const { inventory } = useSelector((state) => state.inventory);

  const dispatch = useDispatch();

  useEffect(() => {
    dispatch(getAllMaintenanceIndustrialFan());
  }, [dispatch]);
