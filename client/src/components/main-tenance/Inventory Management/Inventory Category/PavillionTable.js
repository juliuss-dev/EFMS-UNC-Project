...
import { getAllMaintenancePavillionTable } from "../../../../redux/actions/inventoryAction";

function PavillionTable() {
  const { inventory } = useSelector((state) => state.inventory);

  const dispatch = useDispatch();

  useEffect(() => {
    dispatch(getAllMaintenancePavillionTable());
  }, [dispatch]);
